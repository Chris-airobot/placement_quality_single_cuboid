...
class RRTTask(BaseTask):
    ...
    def set_params(
        ...
        object_scale: Optional[np.ndarray] = None,
        ...
        if object_scale is not None:
            self.set_cuboid_scale(self.preview_box, object_scale)
            self.set_cuboid_scale(self._ycb, object_scale)
    ...
    def set_cuboid_scale(self, object, new_scale):
        prim = object.prim
